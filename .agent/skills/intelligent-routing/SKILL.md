...
| ------------------- | ------------------------------------------ | ------------------------------------------- | ------------ |
| **Authentication**  | "login", "auth", "signup", "password"      | `@security-auditor` + `@backend-developer` | ✅ YES       |
| **UI Component**    | "button", "card", "layout", "style"        | `@frontend-developer`                    | ✅ YES       |
| **Mobile UI**       | "screen", "navigation", "touch", "gesture" | `@mobile-developer`                      | ✅ YES       |
| **API Endpoint**    | "endpoint", "route", "API", "POST", "GET"  | `@backend-developer`                     | ✅ YES       |
| **Database**        | "schema", "migration", "query", "table"    | `@database-architect` (Vero-DB Only)     | ✅ YES       |
